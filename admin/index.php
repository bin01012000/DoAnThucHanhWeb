<?php
include './config.php';
function loadClassAdmin($c)
{
    include "./classadmin/$c.php";
}
if (!isset($_SESSION)) session_start();
spl_autoload_register('loadClassAdmin');

$controller = utilities::get('controller', 'loginadmin');
$obj = new nhaccu();
